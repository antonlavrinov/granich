  ...
  plugins: [
    ...
    },
    {
      ...
      options: {
        ...
        icons: [
          {
            src: `src/assets/images/48x48.png`,
            sizes: `48x48`,
            type: `image/png`,
          },
          {
            src: `src/assets/images/72x72.png`,
            sizes: `72x72`,
            type: `image/png`,
          },
          {
            src: `src/assets/images/96x96.png`,
            sizes: `96x96`,
            type: `image/png`,
          },
          {
            src: `src/assets/images/144x144.png`,
            sizes: `144x144`,
            type: `image/png`,
          },
          {
            src: `src/assets/images/192x192.png`,
            sizes: `192x192`,
            type: `image/png`,
          },
          {
            src: `src/assets/images/256x256.png`,
            sizes: `256x256`,
            type: `image/png`,
          },
          {
            src: `src/assets/images/384x384.png`,
            sizes: `384x384`,
            type: `image/png`,
          },
          {
