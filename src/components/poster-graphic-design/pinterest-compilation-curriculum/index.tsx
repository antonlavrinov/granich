...
const PinterestCompilationCurriculum = ({ data }) => {
    ...
    return (
        <SC.Wrapper>
            ...
            <SC.Descr>
                <b>Рекомендуем вам изучить Энциклопедию Графдизайна.</b> <p>В этой энциклопеди вы найдете графические системы и графические идеи. Про графические системы было пояснение на этой странице выше, а графические идеи это по сути точечные приемы, которые мы частично будем разбирать на курсе Плакатного Графдизайна</p>
            </SC.Descr>
        </SC.Wrapper>
    )
}
