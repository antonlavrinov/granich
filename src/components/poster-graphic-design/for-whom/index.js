      ...
      <Container>
        <SC.Wrapper>
          ...
          <SC.InfoWrapper>
            ...
            <SC.InfoText>
              Курс построен на графических системах. Они позволяют развивать насмотренность для графических дизайнеров и веб-дизайнеров. Вы узнаете различные стили и, таким образом, сможете предлагать своим клиентам больше проверенных визуальных решений.
            </SC.InfoText>
          </SC.InfoWrapper>
        </SC.Wrapper>
      </Container>
