        ...
        <CourseExampleWrapper>
          ...
          <CourseExampleInfoWrapper>
            ...
            <CourseExampleInfoText>
              Графическая система это набор правил по дизайну элементов и принципам верстки для конкретного графического стиля. Позволяет вам систематизировано отталкиваться при разработке, в том числе, своих стилей. А также создает продвинутую базу насмотренности.
            </CourseExampleInfoText>
          </CourseExampleInfoWrapper> 
          {/* <ExampleArrow /> */}
        </CourseExampleWrapper>
