      ...
      <Container>
        <SC.Wrapper>
          ...
          <SC.InfoWrapper>
            ...
            <SC.InfoText>
              Курс построен на дизайн-системе и композициях. Это в прямом смысле фундамент для старта в графическом дизайне. Вы сможете уверенно общаться с дизайнерами, создавать макеты по проверенным решениям, и быстрее развиваться в других направлениях дизайна (веб-дизайн, айдентика, медиа-дизайн).
            </SC.InfoText>
          </SC.InfoWrapper>
        </SC.Wrapper>
      </Container>
