...
const SEO = ({ description, lang, meta, title, keywords, ogImage, url, ogImageVk, socialDescription }) => {
  ...
  const metaSocialDescription = socialDescription || description || site.siteMetadata.description
