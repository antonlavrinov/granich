        ...
        <PortfolioWrapper masterClass>
          {!masterClass ? (
            <PortfolioHeader>
              <PortfolioTitleAndContent>
                <PortfolioHeaderTitle>
                  {dataHeader.portfolioHeaderTitle}
                </PortfolioHeaderTitle>
              ...
              <PortfolioBonusBlock>
                {documentToReactComponents(
                  dataHeader.portfolioHeaderInfo.json,
                  options
                )}
              </PortfolioBonusBlock>
            </PortfolioHeader>
            ...
            <PortfolioHeader masterClass>
              <PortfolioTitleAndContent>
                <PortfolioHeaderTitle masterClass>
                  {dataHeader.portfolioHeaderTitle}
                </PortfolioHeaderTitle>
              </PortfolioTitleAndContent>
          ...
          {!masterClass && (
            <PortfolioSubtitle>Многостраничные экзамены:</PortfolioSubtitle>
          )}
              ...
              {imageGallery.length > 0 && (
                <PortfolioMiltiPagesWrapper>
                  {imageGallery.map((multi, idx) => {
                    return <PortfolioImageGallery key={idx} images={multi} />
                  })}
                </PortfolioMiltiPagesWrapper>
              )}
            </>
          ...
          <PortfolioLinks>
            <PortfolioLink
              ...
              target="_blank"
              href="https://www.pinterest.ru/vadim_granich/granich-graphic-design-course/"
            >
              <PortfolioLinkIcon fluid={pinterestIcon} />
              <PortfolioLinkText>
                Больше плакатов учеников на Pinterest
              </PortfolioLinkText>
            </PortfolioLink>
            {!masterClass && (
              <PortfolioLink
                rel="noopener noreferrer"
                target="_blank"
                href="https://www.behance.net/granich"
              >
                <PortfolioLinkIcon fluid={behanceIcon} />
                <PortfolioLinkText>
                  Больше журналов учеников на Behance
                </PortfolioLinkText>
              </PortfolioLink>
            )}
          </PortfolioLinks>
