...
const OpportunityImage = styled(props => (
...
const CourseOpportunities = () => {
  const dataImage = useStaticQuery(graphql`
    query opportunitiesImages {
      opportunitiesImage1: file(
        relativePath: { eq: "graph-design/opportunities/opportunities-01.jpg" }
      ) {
        childImageSharp {
      ...
      opportunitiesImage2: file(
        relativePath: { eq: "graph-design/opportunities/opportunities-02.jpg" }
      ) {
        childImageSharp {
          fluid(maxWidth: 600, quality: 90) {
            ...GatsbyImageSharpFluid
      ...
      opportunitiesImage3: file(
        relativePath: { eq: "graph-design/opportunities/opportunities-03.jpg" }
      ) {
        childImageSharp {
          fluid(maxWidth: 600, quality: 90) {
            ...GatsbyImageSharpFluid
      ...
      opportunitiesImage4: file(
        relativePath: { eq: "graph-design/opportunities/opportunities-04.jpg" }
      ) {
        childImageSharp {
          fluid(maxWidth: 600, quality: 90) {
            ...GatsbyImageSharpFluid
      ...
      opportunitiesImage5: file(
        relativePath: { eq: "graph-design/opportunities/opportunities-05.jpg" }
      ) {
        childImageSharp {
          fluid(maxWidth: 600, quality: 90) {
            ...GatsbyImageSharpFluid
      ...
      opportunitiesImage6: file(
        relativePath: { eq: "graph-design/opportunities/opportunities-06.jpg" }
      ) {
        childImageSharp {
          fluid(maxWidth: 600, quality: 90) {
            ...GatsbyImageSharpFluid
    ...
    <OpportunitiesSection>
      <Container>
        <OpportunitiesWrapper>
          <OpportunitiesTitle>
            После курса вы сможете <span>выполнять заказы</span> на дизайн
            и вёрстку:
          </OpportunitiesTitle>
          <OpportunitiesSectionWrapper>
            <OpportunitiesSubtitle>
              Одностраничных макетов:
            </OpportunitiesSubtitle>
            <OpportunitiesList>
              <Opportunity
                text={
                  <>
                    <OpportunityTag>Плакаты</OpportunityTag>
                    <OpportunityTag>Афиши</OpportunityTag>
                    <OpportunityTag>Флаеры</OpportunityTag>
                    <OpportunityTag>Буклеты</OpportunityTag>
                  </>
                }
                image={image1}
              />
              <Opportunity
                text={
                  <>
                    <OpportunityTag>Сторис</OpportunityTag>
                    <OpportunityTag>Обложки постов</OpportunityTag>
                  </>
                }
                image={image2}
              />
              <Opportunity
                text={
                  <>
                    <OpportunityTag>Баннеры на сайты</OpportunityTag>
                    <OpportunityTag>Оформление соцсетей</OpportunityTag>
                  </>
                }
                image={image3}
              />
          ...
          <OpportunitiesSectionWrapper>
            <OpportunitiesSubtitle>
              Многостраничных макетов:
            </OpportunitiesSubtitle>
            <OpportunitiesList>
              <Opportunity
                text={
                  <>
                    <OpportunityTag>Журналы</OpportunityTag>
                    <OpportunityTag>Книги</OpportunityTag>
                    <OpportunityTag>Брошюры</OpportunityTag>
                  </>
                }
                image={image4}
              />
              <Opportunity
                text={
                  <>
                    <OpportunityTag>Презентации</OpportunityTag>
                  </>
                }
                image={image5}
              />
              <Opportunity
                text={
                  <>
                    <OpportunityTag>Карусели</OpportunityTag>
                  </>
                }
                image={image6}
              />
