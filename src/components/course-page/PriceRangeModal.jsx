              ...
              >
                <FormWrapper>
                  ...
                  <FormContainer>
                    ...
                    >
                      <FormLabelText>пакет Презентация</FormLabelText>
                      <FormLabelPrice>
                        {`${data.edges[0].node.pricesPrice}`} ₽
                      </FormLabelPrice>
                    </FormCheckboxLabel>
                    ...
                    >
                      <FormLabelText>пакет Видеоформат</FormLabelText>
                      <FormLabelPrice>
                        {`${data.edges[1].node.pricesPrice}`} ₽
                      </FormLabelPrice>
                    </FormCheckboxLabel>
                    ...
                    <FormCheckboxLabel
                      ...
                      htmlFor={`${data.edges[2].node.pricesPrice}`}
                    >
                      <FormLabelText>пакет Домашнее Задание</FormLabelText>
                      <FormLabelPrice>
                        {`${data.edges[2].node.pricesPrice}`} ₽
                      </FormLabelPrice>
                    </FormCheckboxLabel>
                    ...
                    >
                      <FormLabelText>пакет Макет с нуля</FormLabelText>
                      <FormLabelPrice>
                        {`${data.edges[3].node.pricesPrice}`} ₽
                      </FormLabelPrice>
                    </FormCheckboxLabel>
                    ...
                    <FormInputLabel htmlFor="formParams[email]">
                  ...
                  <FormFooterContainer>
                    <FormButtonBlock>
                      <FormButton
                        ...
                        id="button1106661"
                        onClick={() => {
                          if (window["btnprs5f64b2ecda34e"]) {
                            return false
                          }
                          window["btnprs5f64b2ecda34e"] = true
                          setTimeout(function () {
                            window["btnprs5f64b2ecda34e"] = false
                          }, 6000)
                          return true
                        }}
                      >
                ...
                <input
                  ...
                  value="c9053cad472435748de642c5ffebb7c2"
                />
