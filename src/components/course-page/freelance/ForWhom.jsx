...
const ExclamationMarkThickIcon = styled(props => (
  <ExclamationMarkThick {...props} />
))`
  width: 1.4vw;
      ...
      <Container>
        <CourseExampleWrapper>
          ...
          <CourseExampleInfoWrapper>
            <ForWhomLeft>
              <span>
                Этот курс-наставничество подходит следующим специалистам:
              </span>
              <ForWhomTags>
                {tags.map((tag, idx) => (
            ...
            <CourseExampleInfoBlock>
              <CourseExampleInfoText>
                Этот курс-наставничество я разработал специально для вас —
                творческих специалистов. Будучи графическим дизайнером с
                бизнес-образованием, я заметил на рынке фриланса серьёзную
                проблему —{" "}
                <ForWhomRedText>
                  творцы плохо понимают бизнес <ExclamationMarkThickIcon />
                </ForWhomRedText>{" "}
                <ForWhomWavyText>
                  Вы не видите полной картины
                  <WavyLine />
                </ForWhomWavyText>{" "}
                того, как ваше творчество помогает реализовать бизнес-стратегию
                заказчиков, и какие выгоды это приносит. Поэтому Курс направлен
                на то, чтобы вы соединили своё творческое мышление с бизнесом.
                Это сделает вас востребованными на фрилансе.
              </CourseExampleInfoText>
            </CourseExampleInfoBlock>
          </CourseExampleInfoWrapper>
        </CourseExampleWrapper>
