...
const FreelanceCombinationLogo = styled(props => (
  <FreelanceCombinationLogoIcon {...props} />
))`
  width: 12vw;
  min-width: 12vw;
  margin-right: 1.6vw;
...
const combinationsObj = [
  {
    ...
    title: "Курс",
    text:
      "Вы идёте по спланированной учебной программе — с лекциями, презентациями и ДЗ к ним.",
  },
  {
    id: 2,
    title: "Наставничество",
    text:
      "Вы получаете от меня личные разборы, чтобы повысить качество усвоения материала.",
  },
]
