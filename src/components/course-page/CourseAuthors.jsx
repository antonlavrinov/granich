                ...
                <AuthorsWrapper>
                    ...
                    <AuthorsTeachers>
                        {data.edges.map((teacher) => {
                            return (
                                <MasterClassTeacherBlock key={teacher.node.id} numberOfTeachers={numberOfTeachers} teacher={teacher.node}/>
...
const MasterClassTeacherBlock = ({numberOfTeachers, teacher}) => {
    ...
    return (
        <TeacherWrapper numberOfTeachers={numberOfTeachers}>
            <TeacherHeader>
                <TeacherImage numberOfTeachers={numberOfTeachers}  fluid={teacher.teacherImage.fluid}></TeacherImage>
                <TeacherSocials>
