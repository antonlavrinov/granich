            ...
            <Container>
                <ExampleWrapper>
                    ...
                    <ExampleInfoWrapper>
                        ...
                        <ExampleInfoText>
                        <span>Исследование проходит по 6 элементам дизайна и 3 принципам вёрстки</span>Тем не менее, вам необязательно проходить курс Осознанный Графдизайн, чтобы изучить мастер-класс по графсистеме. Все необходимые моменты есть в презентации графсистемы.
                        </ExampleInfoText>
                    </ExampleInfoWrapper>
                </ExampleWrapper>
            </Container>
