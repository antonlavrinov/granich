...
const CourseExplain = () => {
  const data = useStaticQuery(graphql`
    query explainImage {
      explainImageFry: file(
        relativePath: {
          eq: "graph-design/explain/shut-up-and-take-my-money.png"
        }
      ) {
        childImageSharp {
    ...
    <ExplainSection id="individual-Explain">
      <Container>
        <ExplainWrapper>
          ...
          <ExplainInfoWrapper>
            <ExplainInfoText>
              Овладев графдизайном вы станете визуальным голосом ваших клиентов.
              Через макеты вы дадите возможность их бизнесу оповещать, обучать,
              убеждать.{" "}
            </ExplainInfoText>
            <ExplainInfoBonus>
              {/* <ExplainBonusWrapper> */}
              <ExplainInfoBonusText>
