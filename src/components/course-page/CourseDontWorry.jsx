    ...
    return (
        <DontWorryWrapper>
            ...
            <DontWorryTextWrapper>
                <DontWorryText>
                    Система отстранений на курсе сделана, чтобы мотивировать вас.
                    Нагрузки продуманы так, чтобы до отстранения не доходило.
                    Если вы будете целенаправленно заниматься хотя бы <span>2 часа</span> каждый день, то вы справитесь. Отстранения нужны для того,
                    чтобы не позволять оставаться на курсе совсем уже
                    разленившимся людям.
                </DontWorryText>
                <RunIcon />
