    ...
    <BooksItemWrapper>
      ...
      <BooksItemInfo>
        <BooksItemInfoDetails>
          ...
          <BooksItemInfoLinks className="collection_link">
...
const Books = ({ data, categoryTwo, categoryThree }) => {
  ...
  useEffect(() => {
    const firstCategoryItems = data.filter(
      booksItem => booksItem.node.booksCategory === "1"
    )
    const secondCategoryItems = data.filter(
      booksItem => booksItem.node.booksCategory === "2"
    )
      ...
      <Container>
        <BooksWrapper>
          <BooksHeader>
            ...
            <BooksSectionText>
              Книги я расставил в порядке приоритета
              <br />
                ...
                return (
                  <React.Fragment key={booksItem.node.id}>
                    <BooksItem
                      ...
                      text={booksItem.node.booksText.json}
                    />
                  </React.Fragment>
                )
              })}
          ...
          {categoryTwo && (
            <BooksList>
              <BooksListDescr style={{ width: "42vw" }}>
                {categoryTwo}
              </BooksListDescr>
              <Masonry
                breakpointCols={breakpointColumnsObj}
