            ...
            <Container>
                <ForGraduatesWrapper>
                    ...
                    <ForGraduatesText>
                        ...
                        <span>Напишите нашему координатору выпускников.</span> За комиссию он подберёт грамотного дизайнера именно под ваш проект. С гарантией качества его работы. Вдобавок, наш координатор может помочь вам структурировать проект (его цель, этапы, методы оценки результата) и вести его.
