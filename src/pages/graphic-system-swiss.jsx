...
const GraphicSystemSwissPage = ({data}) => (
  <Layout>
    ...
    <CourseAuthors numberOfTeachers={'3'} 
                   ...
                   text={(<>Швейцарский стиль — графсистема вне времени. Она не привязана к трендам, не имеет национальности. Её принципы можно использовать в любой отрасли дизайна, для любой аудитории. Поэтому она так важна. Многим Swiss кажется слишком сложной. Мы постарались разложить всё по полочкам и сделать её понятнее.</>)}/>
    <MasterClassExample/>
    ...
    {data.SwissOffer.courseStatus ? (
      <CoursePriceRange formId={`ltForm3153227`}  
                        valueInput1={`1372632`}
                        valueInput2={`1372669`}
                        valueInput3={`1372671`}
                        valueInput4={`1372674`}
