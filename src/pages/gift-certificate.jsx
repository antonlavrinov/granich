...
export const contentfulQuery = graphql`
    query contentfulQueryGiftCertificate {
        giftCertificate: allContentfulGranichLegalDoc(filter: {legalDocType: {in: ["Подарочный сертификат"]}}) {
            edges {
                node {
...
const GiftCertificatePage = ({ data }) => {
    const mainText = data.giftCertificate.edges[0].node.childContentfulGranichLegalDocLegalDocTextRichTextNode.json;
